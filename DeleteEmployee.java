...
public class DeleteEmployee extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(userName);
        userName.setBounds(268, 136, 198, 22);
        ...
        add(email);
        email.setBounds(268, 167, 198, 22);
        ...
        emps.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "UserId", "user name ", "name", "rank", "email", "Gender", "Hire Date", "Date Of Birth"
            }
        ) {
        ...
        if (emps.getColumnModel().getColumnCount() > 0) {
            emps.getColumnModel().getColumn(0).setMinWidth(0);
            emps.getColumnModel().getColumn(0).setPreferredWidth(0);
            emps.getColumnModel().getColumn(0).setMaxWidth(0);
        }

        add(jScrollPane1);
        jScrollPane1.setBounds(100, 290, 670, 150);
