...
public class Addresses implements Serializable {
    ...
    private Collection<Nutritionist> nutritionistCollection;
    @OneToMany(mappedBy = "addressId")
    ...
    @XmlTransient
    public Collection<Nutritionist> getNutritionistCollection() {
        return nutritionistCollection;
    }

    public void setNutritionistCollection(Collection<Nutritionist> nutritionistCollection) {
        this.nutritionistCollection = nutritionistCollection;
    }
