...
public class User implements Serializable {
    ...
    public void setName(String name) throws SQLException, ClassNotFoundException {
        String sql = "update  user  " + " set name = '" + name+"' where userid = "+this.userId;
        DatabaseAPI db = new DatabaseAPI();
        db.write(sql);
    }
    ...
    public boolean setPassword(String password, String oldpass) throws SQLException, ClassNotFoundException {
        ...
        if (s.next()) {
            this.password = password;
            String sql1 = "update  user  " + " set password = '" + password+"' where userid = "+this.userId;
    ...
    public void setEmail(String email) throws SQLException, ClassNotFoundException {
        this.email = email;
         String sql = "update  user  " + " set email = '" + email+"' where userid = "+this.userId;
        DatabaseAPI db = new DatabaseAPI();
        db.write(sql);
    ...
    public void setDateOfBirth(Date dateOfBirth) throws SQLException, ClassNotFoundException {
        ...
        String sql = "update  user  " + " set dateOfBirth = '" + dateOfBirth+"' where userid = "+this.userId;
        DatabaseAPI db = new DatabaseAPI();
        db.write(sql);
    ...
    public void setAddressId(Addresses addressId) throws SQLException, ClassNotFoundException {
        ...
        if (set.next()) {
             String sql = "update  user  " + " set addressid = '" + addressId.getAddressId()+"' where userid = "+this.userId;
            db.write(sql);
